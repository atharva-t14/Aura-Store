                ...
                <div className="w-full lg:w-[40%] flex items-center justify-center p-4 sm:p-8 bg-[var(--bg-surface)]/50">
                    <div className="w-full max-w-sm bg-[var(--bg-surface)] border border-[var(--bg-muted)] rounded-2xl shadow-2xl p-8 space-y-6 text-[var(--text-primary)]">
                        <div className="space-y-2">
                            ...
                            <h2 className="text-4xl font-bold bg-gradient-to-r from-brand to-brand-dark bg-clip-text text-transparent">Sign up</h2>
                        </div>
                        ...
                        <div className="pt-4 border-t border-[var(--bg-muted)]">
                            <p className="text-sm text-[var(--text-muted)] text-center">Already have an account? <a href="/login" className="text-brand hover:text-brand-dark font-semibold transition">Log in</a></p>
                        </div>
                    </div>
                </div>
